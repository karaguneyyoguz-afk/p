...
function formatCategoryCode(code) {
    const labels = {
        ...
        FATURA_TALEBI_SIKAYETLERI: 'Fatura Talebi ve Şikayetleri',
        GUEST_INVOICE: 'Misafir Faturası',
        MISAFIR_FATURASI: 'Misafir Faturası',
        INVOICE_INFORMATION_MODIFICATION: 'Fatura Bilgi Değişikliği',
        FATURA_BILGI_DEGISIKLIGI: 'Fatura Bilgi Değişikliği',
        GENEL_TESEKKUR: 'Genel Teşekkür',
        REHBER_TESEKKUR: 'Rehber Teşekkür',
        DANISMAN_TESEKKUR: 'Danışman Teşekkür',
        TESIS_ILETISIM: 'Tesis İletişim',
